...
public:
    ...
    std::string set_print_acceleration(unsigned int acceleration, unsigned int accel_to_decel)   { return set_acceleration_internal(Acceleration::Print, acceleration, accel_to_decel); }
    std::string set_travel_acceleration(unsigned int acceleration, unsigned int accel_to_decel)  { return set_acceleration_internal(Acceleration::Travel, acceleration, accel_to_decel); }
...
private:
    ...
    std::string set_acceleration_internal(Acceleration type, unsigned int acceleration, unsigned int accel_to_decel);
};
