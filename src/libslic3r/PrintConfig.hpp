...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,               first_layer_accel_to_decel_over_raft))
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloats,               machine_max_accel_to_decel))
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionFloat,              bridge_accel_to_decel))
    ...
    ((ConfigOptionFloat,              first_layer_accel_to_decel))
    ...
    ((ConfigOptionFloat,              infill_accel_to_decel))
    ...
    ((ConfigOptionFloat,              perimeter_accel_to_decel))
    ...
    ((ConfigOptionFloat,              solid_infill_accel_to_decel))
    ...
    ((ConfigOptionFloat,              top_solid_infill_accel_to_decel))
    ((ConfigOptionInt,                top_solid_infill_jerk))
    ((ConfigOptionFloat,              travel_acceleration))
    ((ConfigOptionFloat,              travel_accel_to_decel))
    ((ConfigOptionInt,                travel_jerk))
    ((ConfigOptionBools,              wipe))
    ((ConfigOptionBool,               wipe_tower))
    ((ConfigOptionFloat,              wipe_tower_acceleration))
    ((ConfigOptionFloat,              wipe_tower_accel_to_decel))
